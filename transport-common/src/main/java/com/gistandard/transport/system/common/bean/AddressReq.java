 ...
 * @Date 2016/1/26
 */
@ApiModel(description  = "地址新增对象", parent = AppBaseRequest.class)
public class AddressReq extends AppBaseRequest implements ValidTokenMark{
	...
	@ApiModelProperty(value = "详细地址(选择街道)",required = true, position = 8)
	...
	@ApiModelProperty(value = "详细地址(比如门牌号)",required = true, position = 15)
	...
	@ApiModelProperty(value = "省名称",required = true, position = 19)
	private String provinceName;
	@ApiModelProperty(value = "市名称",required = true, position = 20)
	private String cityName;
	@ApiModelProperty(value = "区名称",required = true, position = 21)
