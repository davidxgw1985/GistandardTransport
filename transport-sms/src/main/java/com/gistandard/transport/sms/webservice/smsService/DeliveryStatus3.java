 ...
 * 
 */
@XmlType(name = "DeliveryStatus", namespace = "http://www.csapi.org/schema/wap")
@XmlEnum
public enum DeliveryStatus3 {
    ...
    public static DeliveryStatus3 fromValue(String v) {
        for (DeliveryStatus3 c: DeliveryStatus3 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
