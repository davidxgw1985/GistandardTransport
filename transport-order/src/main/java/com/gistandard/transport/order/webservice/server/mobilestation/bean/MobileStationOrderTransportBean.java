...
/**
 * @author yjf
 * @ClassName MobileStationOrderTransportBean
 * @Description 移动station下单Bean
 * @Version 1.0
 * @Date 2016-03-21
 */
public class MobileStationOrderTransportBean implements Serializable {
    private static final long serialVersionUID = -2426734105560090774L;
    //订单主表编号
    ...
    public String getRevUserListStr() {
        return revUserListStr;
    }

    public void setRevUserListStr(String revUserListStr) {
        this.revUserListStr = revUserListStr;
    }
