...
/**
 * @author: xgw
 * @ClassName: CustomerOrderListBean
 * @Date: 2017/3/23
 * @Description: BookingForm订单信息+BillingFormSalm货物列表信息
 */
public class CustomerOrderListBean {
    ...
    private List<BillingFormSalm> goodsList;
    ...
    public List<BillingFormSalm> getGoodsList() {
        return goodsList;
    }

    public void setGoodsList(List<BillingFormSalm> goodsList) {
