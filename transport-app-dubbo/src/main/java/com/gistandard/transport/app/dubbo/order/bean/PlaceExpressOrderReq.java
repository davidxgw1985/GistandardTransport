...
/**
 * @author: xgw
 * @ClassName: PlaceExpressOrderReq
 * @Date: 2017/7/31
 * @Description: 快递下单请求Bean
 */
public class PlaceExpressOrderReq  implements Serializable {

    private static final long serialVersionUID = 6138103298764170959L;
