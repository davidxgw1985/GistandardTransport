...
/**
 * @author: xgw
 * @ClassName: MobileSubOrderDubbo
 * @Date: 2017/7/4
 * @Description: 对应子订单表
 */
public class MobileSubOrderDubbo implements Serializable{
    private static final long serialVersionUID = 8054407059549319613L;
    ...
    private List<MobileGoodsDtlDubbo> mobileGoodDtlList;
    ...
    public List<MobileGoodsDtlDubbo> getMobileGoodDtlList() {
        return mobileGoodDtlList;
    }

    public void setMobileGoodDtlList(List<MobileGoodsDtlDubbo> mobileGoodDtlList) {
