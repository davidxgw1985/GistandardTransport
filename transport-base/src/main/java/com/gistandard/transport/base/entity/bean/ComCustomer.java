...
public class ComCustomer implements Serializable {
    private static final long serialVersionUID = 7724633326134313519L;
    ...
    private Integer bizProvince;

    private Integer bizCity;

    private Integer bizCounty;
    ...
    public Integer getBizProvince() {
        return bizProvince;
    }

    public void setBizProvince(Integer bizProvince) {
        this.bizProvince = bizProvince;
    }

    public Integer getBizCity() {
        return bizCity;
    }

    public void setBizCity(Integer bizCity) {
        this.bizCity = bizCity;
    }

    public Integer getBizCounty() {
        return bizCounty;
    }

    public void setBizCounty(Integer bizCounty) {
