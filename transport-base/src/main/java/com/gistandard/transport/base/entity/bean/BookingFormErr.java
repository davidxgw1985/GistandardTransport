...
public class BookingFormErr implements Serializable {
    private Integer id;
    ...
    private Boolean focusAccessTime;

    private Boolean focusDeliveryTime;
