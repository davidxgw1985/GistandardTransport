...
<section class="wrapper">
    <div class="top">
        ...
        <span class="tp-title">咪站升级说明</span>
    </div>
    <div class="content">
        <p class="con-tips">咪站升级流程</p>
        <section class="con-type anm-bounceInRight">
            <section class="tp-line"></section>
            <section class="tp-courier">
                <div class="cou-img">
                    <p class="flow-exp flow1">填写</p>
                    <p class="flow-exp">位置信息</p>
                </div>

            </section>
        </section>
        <section class="con-exp anm-bounceInRight">
            <p class="tp-mes">填写您的位置信息和营业时间</p>
        </section>
        <section class="con-type anm-bounceInRight1">
            <section class="tp-line"></section>
            <section class="tp-courier">
                <div class="cou-img">
                    <p class="flow-exp flow1">提交申请</p>
                    <p class="flow-exp">等待审核</p>
                </div>

            </section>
        </section>
        <section class="con-exp anm-bounceInRight1">
            <p class="tp-mes">升级资料提交后,需要等待平台的审核,一般为1-4个工作日</p>
        </section>
        <section class="con-type anm-bounceInRight2">
            <section class="tp-line"></section>
            <section class="tp-courier">
                <div class="cou-img">
                    <p class="flow-exp flow1">审核成功</p>
                    <p class="flow-exp">正式运营</p>
                </div>

            </section>
        </section>
        <section class="con-exp anm-bounceInRight2">
            <p class="tp-mes">恭喜您可以接单啦!</p>
        </section>
        <div class="btn-next btn-mz-next anm-bounceInRight3">下一步
        </div>
