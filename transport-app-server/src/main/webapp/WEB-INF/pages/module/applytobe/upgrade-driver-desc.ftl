...
<body style="-webkit-overflow-scrolling: touch;" class="single">
	<section class="wrapper">
		...
		<div class="content">
			<p class="con-tips">司机升级流程</p>
			<section class="con-type anm-bounceInRight">
				<section class="tp-line"></section>
				<section class="tp-courier">
					<div class="cou-img">
						<p class="flow-exp flow1">提交</p>
						<p class="flow-exp">真实资料</p>
					</div>
					
				</section>
			</section>
			<section class="con-exp">
				<p class="tp-mes anm-bounceInRight"></p>
			</section>
			...
			<div class="btn-next btn-driver-next anm-bounceInRight3">下一步
